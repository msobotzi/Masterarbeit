...
For the phase2 tracking efficiency, we saw that most of the time, the tracking efficiency of phase2 MC is higher than the tracking efficiency of phase2 data. But this was expected, because on MC, there are no dead times, the detector is always performing at its best and some structures of the detector, like cabling or screws, which may interfere with the outgoing particles, are maybe not implemented in the simulation which ultimately leads to a higher efficiency. Unfortunately, the phase2 MC has noticeably larger error bars due to the lower statistics.
...
Overall, there was no improvement from phase2 to phase3 in the barrel. But, the tracking efficiency in both end-caps got way better for electrons and positrons.
