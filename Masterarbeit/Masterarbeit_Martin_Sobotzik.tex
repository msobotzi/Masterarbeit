...
In equation \ref{eq:EffError}, $\epsilon$ is the calculated efficiency and $n$ is the total number reconstructed particles with and without an associated track in the investigated bin.
...
\textcolor{red}{plot fuer mc and data was No. ausgewaehlte kandidaten pro events zeigt und damit auch die totale zahl der events nach der selection. Sowohl fuer MC als auch fuer beamtime data}
...
\subsubsection{Forward Cap}

\subsubsection{End Cap}
...
\chapter{Tracking Efficiencies For Phase3}
