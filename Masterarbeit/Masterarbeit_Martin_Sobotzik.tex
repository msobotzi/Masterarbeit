...
\begin{table}[h!]
	...
	\begin{tabular}{lccc}
		&Random&$\textrm{e}^-$ &$\textrm{e}^+$\\
		\hline
		Momentum &$1\,\textrm{GeV} - 9\,\textrm{GeV}$&$3\,\textrm{GeV} - 9\,\textrm{GeV}$&$2\,\textrm{GeV} - 7\,\textrm{GeV}$\\
...
\lettrine{I}{n} this chapter the tracking efficiency studies on phase2 will be presented. The selection described in chapter \ref{chap:Phase2Eff} will be used in this chapter.
