...
\epigraph{Before there was earth or sea or the sky that covers everything, Nature appeared the same throughout the whole world: what we call chaos: a raw confused mass, nothing but inert matter, badly combined discordant atoms of things, confused in the one place.}{Ovid - Matamorphoses}
...
Since the same selection is used on to calculate the tracking efficiency phase2 and phase3 one can compare them. This will be done in chapter \ref{cha:Comp}.
