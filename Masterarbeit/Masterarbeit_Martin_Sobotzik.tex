...
The luminosity is measured by using Bhabha and $\gamma \gamma$ events. These events are also used to calibrate the detector response. Due to their high cross section, these events are very dominant. That is the reason why there is a prescaling factor of 100  on these events. This means that on  predetermined fraction of these events are accepted after satisfying the trigger requirements.
