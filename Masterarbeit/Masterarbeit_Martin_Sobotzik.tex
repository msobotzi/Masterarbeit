...
\end{figure}
 ...
 Figure \ref{plt:RTPMemD_Data} shows the same plots but for phase2 data. Small differences for momenta between $4\,\textrm{GeV}$ and more at an azimuthal angle $\phi$ of about $0^\circ$ are probably caused by the geometry of the vertex detector. As already mentioned in section \ref{sec:Phase2}, only a small azimuthal fraction was installed at $\phi \approx 0$.
