...
Last but not least, a short conclusion will be given in chapter \ref{cha:Conclusion}.
\newline 
...
Using Monte Carlo-Truth information, these are the informations of the generated MC particle and therefore the truth properties of these particles, I tried to shown that it is possible to select outgoing electron/positron events, also known as Bhabha events, with informations solely coming from the electromagnetic calorimeter (ECL), a sub-detector of Belle II. 
...
For the phase2 tracking efficiency, we saw that most of the time, the tracking efficiency of phase2 MC is higher than the tracking efficiency of phase2 data. Unfortunately, the phase2 MC has noticeably larger error bars due to the lower statistics.
