...
In line twelve, a virtual photon of the bhabha event is reconstructed from the ECL objects in the \texttt{vpho:ECLObject} list. The number of reconstructed virtual photon candidates per event $n_{cand}$ is determined by the following equation\cite{triangular}:
...
\subsection{How To Produce The Tables In The Efficiency Cuts Chapter}

To reproduce the tables \ref{tab:clusterSplitting} and \ref{tab:ESum} you will need the file: \texttt{bhabha\_vpho\_mc.root} which is located at: /home/belle2/msobotzi/bhabha/
