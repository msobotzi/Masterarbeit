...
\begin{textblock*}{8cm}(1.5cm,1.5cm)
	\includegraphics[width=\textwidth]<1>{VBilder/cdc}
\end{textblock*}


\begin{textblock*}{11cm}(.cm,-3.3cm)
...
\begin{frame}{Introducing Cuts}
	...
	\begin{itemize}
		...
		\item<5-> Data also contains $\textrm{e}^+ \textrm{e}^- \rightarrow \gamma \gamma$
	\end{itemize}
...
\begin{textblock*}{5cm}(-0.3cm,1.5cm)
	\begin{table}[h!]
		...
		\begin{tabular}{lc}
			&p\\
			\hline
			$\textrm{e}^-$& $4\,\textrm{GeV} - 9\,\textrm{GeV}$\pause[5]\\	
		...
		\only<7->{
			\begin{mybox}
				...
				\begin{itemize}
					...
					\item The tracking efficiency pf phase3 MC and phase3 data are close to each other (an exception occurs in the backward end-cap for momenta between $2\,\textrm{GeV}$ and $4\,\textrm{GeV}$ and between $6\,\textrm{GeV}$ and $7\,\textrm{GeV}$) 
