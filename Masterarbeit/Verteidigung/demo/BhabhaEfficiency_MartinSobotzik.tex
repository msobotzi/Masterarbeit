...
\begin{textblock*}{5.2cm}(0cm,-3.7cm)
	...
	\begin{itemize}
		...
		\item[] $\rightarrow$ The position and the energy of the particle can be determined
		...
		\only<7->{
			\begin{mybox}
				...
				\begin{itemize}
					...
					\item The tracking efficiency pf phase3 MC and phase3 data are close to each other (exception occurs in the backward end-cap for momenta between $3\,\textrm{GeV}$ and $4\,\textrm{GeV}$ and between $6\,\textrm{GeV}$ and $7\,\textrm{GeV}$) 
