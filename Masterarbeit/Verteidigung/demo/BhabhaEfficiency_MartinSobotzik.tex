...
\begin{figure}
	...
	\includegraphics[width=\textwidth]<2>{VBilder/belleR}
\end{figure}
...
\begin{frame}{Vertex Detectors (VXD)}
		...
		\begin{textblock*}{6cm}(2.5cm,-1.1cm)
		\begin{figure}
	...
	\begin{textblock*}{5cm}(0.cm,1cm)
		\includegraphics[width=\textwidth]<2>{VBilder/VXD_phaseII}
	\end{textblock*}
	
	
		\begin{textblock*}{4cm}(6.5cm,0cm)
	...
	\begin{textblock*}{10cm}(-0cm,-3.7cm)
			...
			\begin{itemize}
				...
				\item Both detectors consist of multiple ladders in multiple layers (2 PXD with radii of $14$ and $22\,\textrm{mm}$ and 4 SVD with radii of 38, 80, 115 and $140\,\textrm{mm}$)
...
\begin{frame}{Bhabha Event Selection}
	...
	\begin{textblock*}{1\textwidth}(0cm,-0.2cm)
		\centering
		\includegraphics[width=\textwidth]<1>{VBilder/hb2b_MCP3.pdf}
	\end{textblock*}
		...
		\begin{textblock*}{1\textwidth}(0cm,-0.2cm)
		\centering
		\includegraphics[width=\textwidth]<2>{VBilder/hb2b_DataP3.pdf}
	\end{textblock*}
	...
	\begin{textblock*}{8cm}(1cm,3.8cm)
		\textcolor{red}{Phase3 MC}: 852093 events survive
...
\end{textblock*}
	...
	\begin{textblock*}{6.5cm}(5cm,-4cm)
		\includegraphics[width=\textwidth]<1>{VPlots/empty}
	\end{textblock*}
...
\begin{frame}{Phase3 Tracking Efficiencies As Function Of $\theta_{\textrm{pred,b2b}}-\phi_{\textrm{pred,b2b}}$}
	...
	\begin{textblock*}{9cm}(1cm,-4cm)
		\includegraphics[width=\textwidth]<1>{VPlots/P3/xCEffTP_MCDataP3}
		
		\includegraphics[width=\textwidth]<2>{VPlots/P3/xCEffTP_MCDataP3em}
		\includegraphics[width=\textwidth]<4>{VPlots/P3/xCEffTP_MCDataP3ep}
	\end{textblock*}
	...
	\begin{textblock*}{7cm}(2cm,-4.cm)
		\includegraphics[width=\textwidth]<5>{VPlots/P3/xCEffTP_DataepP3}
	\end{textblock*}
