...
\begin{textblock*}{6cm}(5.6cm,-3.5cm)
	\begin{mybox}
		...
		\item<3,4> There is no similarity in the structure for momenta between $6\,\textrm{GeV}$ and $7\,\textrm{GeV}$
	...
	\only<4->{
		\begin{mybox}
			...
			\begin{itemize}
				...
				\item The lowest tracking efficiency occurs for momenta between $3\,\textrm{GeV}$ and $4\,\textrm{GeV}$
			\end{itemize}
		\end{mybox}
	}
\end{textblock*}
...
\begin{frame}{Phase2 Tracking Efficiencies As Function Of $\theta_{\textrm{pred,b2b}}$}
	...
	\begin{textblock*}{6cm}(5.6cm,-3.5cm)
		\begin{mybox}
			Electron Tracking Efficiency:
			\begin{itemize}
				\item<2,3,4,5> For momenta between $3\,\textrm{GeV}$ and $5\,\textrm{GeV}$ the tracking efficiency in the backward end-cap is worse for phase2 data compared to phase2 MC
				\item<3,4,5> For momenta between $4\,\textrm{GeV}$ and $6\,\textrm{GeV}$ the tracking efficiency in the forward end-cap is worse for phase2 data compared to phase2 MC
				\item<4,5> Drop in efficiency at transition between barrel and end-caps
				\item<5> A efficiency drop appears to propagate for momenta between $5\,\textrm{GeV}$ and $7\,\textrm{GeV}$ for phase2 data
			\end{itemize}
		\end{mybox}
	\end{textblock*}
	}
...
\only<6->{
	...
	\begin{textblock*}{6cm}(-0.7cm,-3.5cm)
		\begin{mybox}
			Positron Tracking Efficiency:
			\begin{itemize}
				\item<7->	For momenta between $3\,\textrm{GeV}$ and $5\,\textrm{GeV}$ the phase2 data tracking efficiency is lower compared to phase2 MC in the backward end-cap		
				\item<8-> For momenta between $5\,\textrm{GeV}$ and $7\,\textrm{GeV}$ it is vice versa 
			\end{itemize}
		\end{mybox}
	\end{textblock*}
