...
\begin{textblock*}{5.2cm}(0cm,-3.7cm)
	...
	\begin{itemize}
		...
		\item Photons and electromagnetic particles are  creating electromagnetic cascades when they pass through the crystals
	...
	\begin{textblock*}{6cm}(5.6cm,-3.5cm)
		\begin{mybox}
			...
			\begin{itemize}
				...
				\item<4-> The lower \textit{ribbon} of phase3 data seems to follow the phase2 data structure
			\end{itemize}
		\end{mybox}
	\end{textblock*}
	...
	\begin{textblock*}{6cm}(-0.7cm,-3.5cm)
			...
			\begin{mybox}
				...
				\begin{itemize}					
					...
					\pause
					\item The tracking efficiency for momenta between $3\,\textrm{GeV}$ and $5\,\textrm{GeV}$ improved drastically 
				\end{itemize}
			\end{mybox}
