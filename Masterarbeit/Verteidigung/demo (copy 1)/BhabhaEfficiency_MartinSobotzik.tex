...
\begin{frame}{Outline}
	...
	\begin{itemize}
		...
		\item Comparing the tracking efficiency of phase2 and phase3 (data) 
		\item Conclusion
...
\begin{frame}{Bhabha Event Selection}
	...
	\begin{textblock*}{1\textwidth}(0cm,-0.2cm)
		\centering
		\includegraphics[width=\textwidth]<2>{h/hb2b_MCP3.pdf}
	\end{textblock*}
		...
		\begin{textblock*}{1\textwidth}(0cm,-0.2cm)
		\centering
		\includegraphics[width=\textwidth]<1>{h/hb2b_DataP3.pdf}
	\end{textblock*}
...
\begin{textblock*}{4.5cm}(0cm,3.3cm)
	\begin{mybox}
	\small{
	Chose momenta regions with enough statistic using \textcolor{red}{MC}
}
\end{mybox}
